...
#define HOST "wangibumi.000webhostapp.com"          // Enter HOST URL without "http:// "  and "/" at the end of URL
...
http.begin(client,"http://wangibumi.000webhostapp.com/dbwrite.php");              // Connect to host where MySQL databse is hosted
